-- =============================================================================
-- Seed: اکانت‌های تستی دیباگ (4 athlete / 4 trainer / 1 admin)
-- =============================================================================
-- اجرا در Supabase → SQL Editor (یک‌بار کافی است؛ idempotent).
--
-- پسورد هر اکانت = همان شماره موبایل.
--
...
-- | athlete | 09129999004 | debug_athlete_2   | 9129999004@gym.ai  | 09129999004 |
-- | athlete | 09129999005 | debug_athlete_3   | 9129999005@gym.ai  | 09129999005 |
-- | athlete | 09129999006 | debug_athlete_4   | 9129999006@gym.ai  | 09129999006 |
-- | trainer | 09129999007 | debug_trainer_2   | 9129999007@gym.ai  | 09129999007 |
-- | trainer | 09129999008 | debug_trainer_3   | 9129999008@gym.ai  | 09129999008 |
-- | trainer | 09129999009 | debug_trainer_4   | 9129999009@gym.ai  | 09129999009 |
--
-- مارکر پاک‌سازی:
--   • username پیشوند debug_
--   • phone در 09129999001..009
...
BEGIN
  FOR r IN
    SELECT * FROM (VALUES
      ...
      (
        'a0112999-9004-4000-8000-000000000004'::uuid,
        '09129999004',
        'debug_athlete_2',
        'athlete',
        'رضا',
      ...
      (
        'a0112999-9005-4000-8000-000000000005'::uuid,
        '09129999005',
        'debug_athlete_3',
        'athlete',
        'سارا',
      ...
      (
        'a0112999-9006-4000-8000-000000000006'::uuid,
        '09129999006',
        'debug_athlete_4',
        'athlete',
        'مهدی',
      ...
      (
        'a0112999-9007-4000-8000-000000000007'::uuid,
        '09129999007',
        'debug_trainer_2',
        'trainer',
        'نیما',
      ...
      (
        'a0112999-9008-4000-8000-000000000008'::uuid,
        '09129999008',
        'debug_trainer_3',
        'trainer',
        'مریم',
      ...
      (
        'a0112999-9009-4000-8000-000000000009'::uuid,
        '09129999009',
        'debug_trainer_4',
        'trainer',
        'حسین',
...
WHERE p.username LIKE 'debug_%'
   OR p.phone_number IN (
     '09129999001', '09129999002', '09129999003',
     '09129999004', '09129999005', '09129999006',
     '09129999007', '09129999008', '09129999009'
   )
