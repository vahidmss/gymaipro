...
### Import کردن
```dart
import 'package:your_app/meal_plan_builder/widgets/widgets.dart';
import 'package:your_app/meal_plan_builder/services/meal_plan_service.dart';
import 'package:your_app/meal_plan_builder/utils/meal_plan_utils.dart';
```

### استفاده از صفحه اصلی
```dart
import 'package:your_app/meal_plan_builder/screens/meal_plan_builder_screen.dart';
