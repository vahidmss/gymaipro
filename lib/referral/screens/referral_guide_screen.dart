    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16.h),
          _buildBenefitItem('دعوت 1 نفر', '30 امتیاز لیگ'),
          SizedBox(height: 12.h),
          _buildBenefitItem('دعوت 3 نفر', '80 امتیاز لیگ + دستاورد نقره‌ای'),
          SizedBox(height: 12.h),
          _buildBenefitItem('دعوت 10 نفر', '200 امتیاز لیگ + دستاورد طلایی'),
          SizedBox(height: 12.h),
          _buildBenefitItem('دعوت 30 نفر', '500 امتیاز لیگ + دستاورد پلاتینی'),
        ],
      ),
    );
  }
