...
├── services/
│   ├── workout_log_service.dart      # Core workout logging service
│   └── workout_program_log_service.dart # Program-specific logging service
├── widgets/
│   └── workout_log_export_button.dart # Export functionality widget
├── dialogs/                          # Custom dialogs for workout logging
