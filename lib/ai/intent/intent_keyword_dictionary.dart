  ...
  static const Map<String, List<IntentKeywordEntry>> entries =
      <String, List<IntentKeywordEntry>>{
        ...
        'progress_analysis': <IntentKeywordEntry>[
          ...
          IntentKeywordEntry(term: 'روند وزن', weight: 1.5),
          IntentKeywordEntry(term: 'وزن کم کردم', weight: 1.3),
          IntentKeywordEntry(term: 'وزن زیاد کردم', weight: 1.3),
          IntentKeywordEntry(term: 'تغییر وزن', weight: 1.3),
          IntentKeywordEntry(term: 'هیت مپ', weight: 1.3),
          IntentKeywordEntry(term: 'هیت‌مپ', weight: 1.3),
          IntentKeywordEntry(term: 'عضله‌هام', weight: 1.2),
        ...
        'recovery': <IntentKeywordEntry>[
          ...
          IntentKeywordEntry(term: 'آمادگی', weight: 1.5),
          IntentKeywordEntry(term: 'آمادگیم', weight: 1.6),
          IntentKeywordEntry(term: 'آماده', weight: 1.2),
          IntentKeywordEntry(term: 'استراحت', weight: 1),
          IntentKeywordEntry(term: 'recovery', weight: 1.2),
          IntentKeywordEntry(term: 'readiness', weight: 1.4),
        ...
        'nutrition': <IntentKeywordEntry>[
          ...
          IntentKeywordEntry(term: 'کالری', weight: 1.5),
          IntentKeywordEntry(term: 'پروتئین', weight: 1.4),
          IntentKeywordEntry(term: 'شام', weight: 1.2),
          IntentKeywordEntry(term: 'غذا', weight: 1.1),
        ...
        'general_fitness': <IntentKeywordEntry>[
          ...
          IntentKeywordEntry(term: 'اضافه وزن', weight: 1.5),
          IntentKeywordEntry(term: 'چاقی', weight: 1.4),
          IntentKeywordEntry(term: 'لاغری', weight: 1.3),
          IntentKeywordEntry(term: 'بی ام آی', weight: 1.5),
          IntentKeywordEntry(term: 'bmi', weight: 1.5),
          IntentKeywordEntry(term: 'چربی بدن', weight: 1.4),
          IntentKeywordEntry(term: 'قد و وزن', weight: 1.3),
          IntentKeywordEntry(term: 'کمبود وزن', weight: 1.3),
        ],
