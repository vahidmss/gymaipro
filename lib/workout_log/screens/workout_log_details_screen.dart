...
class WorkoutLogDetailsScreen extends StatelessWidget {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            _buildHeader(context, persianDate, createdAt),
        ...
        children: [
          ...
          if (userName != null) ...[
            ...
            Row(
              ...
              children: [
                Icon(LucideIcons.user, color: context.textColor, size: 16.sp),
                SizedBox(width: 6.w),
                Text(
                  'کاربر: $userName',
                  style: TextStyle(
  ...
  Widget _buildSummaryItem(
    ...
    return Column(
      children: [
        ...
        Text(
          label,
          style: TextStyle(color: context.textColor, fontSize: 11.sp),
        ),
      ],
    );
  }

  Widget _buildSessionCard(BuildContext context, WorkoutSessionLog session) {
    return Padding(
  ...
  Widget _buildExerciseCard(BuildContext context, dynamic exercise) {
    if (exercise is NormalExerciseLog) {
      return _buildNormalExerciseCard(context, exercise);
    } else if (exercise is SupersetExerciseLog) {
      return _buildSupersetExerciseCard(context, exercise);
    }
    return const SizedBox.shrink();
  }

  Widget _buildNormalExerciseCard(
    BuildContext context,
    NormalExerciseLog exercise,
  ) {
              ...
              Wrap(
                ...
                children: [
                  ...exercise.sets.asMap().entries.map((entry) {
                    ...
                    return _buildSetChip(context, idx, set, exercise.style);
                  }),
                ],
              ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              ...exercise.exercises.map(
                (item) => _buildSupersetItemCard(context, item),
              ),
            ],
          ),
        ),
  ...
  Widget _buildSupersetItemCard(BuildContext context, SupersetItemLog item) {
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                '${item.sets.length} ست',
                style: TextStyle(color: context.textColor, fontSize: 10.sp),
              ),
            ],
          ),
          SizedBox(height: 4.h),
          Row(
            children: [
              Text(
                'مجموع تکرار: $totalReps',
                style: TextStyle(color: context.textSecondary, fontSize: 10.sp),
              ),
              SizedBox(width: 12.w),
              if (totalWeight > 0)
                Text(
          ...
          Wrap(
            ...
            children: [
              ...item.sets.asMap().entries.map((entry) {
                final idx = entry.key;
                final set = entry.value;
                return _buildSetChip(context, idx, set, 'sets_reps');
              }),
            ],
          ),
        ],
