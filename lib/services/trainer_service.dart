...
class TrainerService {
  ...
  Future<List<TrainerReview>> getTrainerReviews(String trainerId) async {
    try {
      ...
      return response.map(TrainerReview.fromJson).toList();
    } catch (e) {
  ...
  Future<List<TrainerClient>> getTrainerClients(String trainerId) async {
    try {
      ...
      return response.map(TrainerClient.fromJson).toList();
    } catch (e) {
  ...
  Future<List<Map<String, dynamic>>> getTrainerClientsWithProfiles(
    String trainerId,
  ) async {
    try {
      final response = await _client
  ...
  Future<List<Map<String, dynamic>>> getClientTrainersWithProfiles(
    String clientId,
  ) async {
    try {
      final response = await _client
