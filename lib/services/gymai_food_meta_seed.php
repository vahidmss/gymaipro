<?php
/**
 * GymAI — موتور seed خوراکی (CORE)
 * دیتا در batchها: gymai-food-snippets/food-batchN.php
 * تولید: python gymai-food-snippets/generate_food_batches.py
 */
...
/**
 * بازسازی لینک داخلی و substitutes برای همه خوراکی‌های seed‌شده.
 *
