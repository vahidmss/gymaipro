...
$allow_any_auth = in_array($upload_context, ['private_chat', 'chat'], true);
...
$kind = in_array($upload_context, ['private_chat', 'chat'], true) ? 'voice' : 'audio';
...
$music_url = $target['url_base'] . '/' . $file_name;
