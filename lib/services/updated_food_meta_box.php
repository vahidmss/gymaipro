<?php
/**
 * متاباکس خوراکی‌ها — GymAI
 * هدف: داده کامل برای برنامه غذایی + لاگ روزانه در اپ
 *
 * نصب: include در functions.php تم یا پلاگین سفارشی
 * CPT: foods (موجود در gymaipro.ir)
 */
...
// =============================================
// ثابت‌ها — واحدهای پیش‌فرض قابل انتخاب
// =============================================
...
// =============================================
// REST API — register_post_meta
// =============================================
add_action('init', 'gymai_register_food_meta_for_rest', 20);
function gymai_register_food_meta_for_rest() {
    $meta_keys = array(
        'name_app', 'other_names', 'food_group', 'food_type', 'meal_times',
