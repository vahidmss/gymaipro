...
DO $$
BEGIN
    RAISE NOTICE 'سیستم چت با موفقیت نصب شد!';
    ...
    RAISE NOTICE 'تریگرها: update_chat_messages_updated_at, update_chat_conversations_updated_at, update_conversation_on_message';
    RAISE NOTICE 'RLS: فعال شده با سیاست‌های امنیتی';
END $$;

-- =====================================================
-- نکات:
-- 1. این فایل مستقیماً سیستم چت را نصب می‌کند
-- 2. اگر جداول قبلی وجود داشته باشند، خطا نمی‌دهد
