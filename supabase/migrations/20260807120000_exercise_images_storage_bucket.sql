-- باکت تصاویر تمرین اختصاصی + سیاست‌های آپلود/خواندن
-- کد اپ از bucket: exercise_images استفاده می‌کند
...
-- سیاست‌های قبلی را اگر با نام مشابه بودند پاک کن (idempotent)
