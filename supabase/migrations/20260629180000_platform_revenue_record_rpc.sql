-- ثبت درآمد پلتفرم پس از پرداخت اشتراک مربی (RLS قبلاً فقط SELECT برای ادمین داشت)
-- اجرا روی api.gymaipro.ir در صورت نیاز دستی
...
COMMENT ON FUNCTION public.record_platform_revenue IS
  'Buyer records platform commission after successful trainer subscription payment; idempotent per subscription.';
