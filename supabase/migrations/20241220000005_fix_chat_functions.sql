...
DROP FUNCTION IF EXISTS add_message_to_conversation(uuid, uuid, uuid, text, text);

-- ایجاد تابع add_message_to_conversation
...
-- ایجاد تابع mark_conversation_as_read
...
-- ایجاد تابع get_unread_message_count
